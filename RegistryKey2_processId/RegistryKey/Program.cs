...
namespace RegistryKey_test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("path: HKEY_CURRENT_USER\\SOFTWARE\\HotTab_processId");
            //if (args[0])
            {
                RegistryWindows.setValue(args[0], args[1]);
            }
            /* 
            //for console
    ...
    class RegistryWindows
    {
        ...
        private static string subkey = @"SOFTWARE\HotTab_processId";
